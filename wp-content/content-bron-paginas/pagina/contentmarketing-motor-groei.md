---
titel: "Contentmarketing: groeien door jezelf te zijn"
slug: "contentmarketing-motor-groei"
oude_url: "https://www.diversions.nl/contentmarketing-motor-groei/"
type: "page"
status: "publish"
concept: false
datum: "2016-08-14 19:20:21"
auteur: "redactie"
categorieen: []
tags: []
excerpt: null
...
1. [Bepaling van doelgroep](https://www.diversions.nl/contentmarketing-motor-groei/#bepaling)
2. [Onderzoek naar de doelgroepwensen](https://www.diversions.nl/contentmarketing-motor-groei/#onderzoek)
3. [Doelstellingen aanscherpen](https://www.diversions.nl/contentmarketing-motor-groei/#doel)
4. [Formulering van de contentformule](https://www.diversions.nl/contentmarketing-motor-groei/#formulering)
5. [Contentcreatie & planning](https://www.diversions.nl/contentmarketing-motor-groei/#creatie)
6. [Analyse & optimalisatie](https://www.diversions.nl/contentmarketing-motor-groei/#analyse)
...
Om deze doelgroepwensen in kaart te brengen gebruiken we bij Diversions het [waarde propositie model](http://www.businessmodelgeneration.com/canvas/vpc) van Osterwalder. Samen met jou of - nog beter - in een sessie met je doelgroep brengen we de wensen in kaart. Dit levert een uitgebreid overzicht van contentthema's op.
...
Ieder project start met verwachtingen en doelstellingen. Deze uitgangspunten neem je (vanzelfsprekend) al mee tijdens het in beeld brengen van doelgroep en doelgroepwensen, maar we blijven ze aanscherpen tijdens het ontwikkelproces. Dat doen we niet voor niets: we willen het redactieteam kraakheldere [KPI](http://kpilibrary.com/) in handen geven om de contentstrategie mee aan te sturen.
...
#### Leren, creëren en optimaliseren. Het is een proces dat nooit stopt. Wij hebben de kennis en tools om optimaal rendement te bereiken met je content.
...
Voor sommige klanten nemen we content marketing volledig uit handen. We bieden het als een full service dienst aan (zoals bij [Achmea Pensioenservices](https://www.diversions.nl/dialoog-op-achmea-pensioenplatform/)). In andere gevallen zoeken we de nauwe samenwerking op met je eigen medewerkers (zoals bij de [Maag Lever Darm Stichting](https://www.diversions.nl/cases/volgende-stap-voor-de-maag-lever-darm-stichting/)).
...
Wil je een start maken met contentmarketing?  Of de effectiviteit van je contentprogramma verbeteren? Wij nemen graag de tijd om te laten zien wat onze aanpak voor jouw organisatie kan betekenen. Neem contact op voor een [vrijblijvende videocall of afspraak](https://www.diversions.nl/contact/).

## Hoe zit dat

*Wat verklaart de snelle opkomst van contentmarketing?*

Het fenomeen "contentmarketing" bestaat nog niet zo lang, maar het gebruik van content voor marketingdoelen is zo oud als marketing zelf. Zeker in [direct marketing](http://visual.ly/brief-history-direct-mail) (DM, wat tot eind van de vorige eeuw een bloeiende industrie was) gold al: content is king. Het is dan ook niet zo vreemd dat veel DM-lessen uit het verleden nu opgaan voor contentmarketing. Het basisidee dat je relevante content biedt aan een scherp gedefinieerde doelgroep is ongewijzigd geërfd uit het DM-tijdperk.
...
Contenmarketing is veelzijdig. Je bouwt als organisatie aan je bekendheid en omzet met uiteenlopende vormen van content. Variërend van artikelen tot video's. Van [infographics](http://www.creativebloq.com/graphic-design-tips/information-graphics-1232836) tot [presentaties](http://www.slideshare.net/search/slideshow?searchfrom=header&q=content+marketing). Deze mix van content zorgt ervoor dat je jouw doelgroep kunt blijven boeien, zonder voortdurend de boodschap te hoeven aanpassen.
