---
service: "Customer journey: passend bij iedere generatie"
description: "Consumenten stellen hoge eisen aan dienstverlening. Ze verwachten van organisaties een hoogwaardige service. Tijdens ieder contact. Via ieder kanaal. Maar wat een klant verstaat…"
---

<!-- CONVERT-META
  oude_url: /customer-journey-passend-bij-iedere-generatie
  nieuwe_url: /services/customer-journey-passend-bij-iedere-generatie
  sanity_type: service
...
## CUSTOMER JOURNEY: PASSEND BIJ IEDERE GENERATIE
...
### generatiesBij Generationjourney.nl gaan we op zoek naar de drijfveren die consumenten van verschillende generaties hebben

- ### Customer Journey: De basis
...
Nog lastiger wordt het als we het gedrag van een generatie niet alleen op functionele wensen beoordelen, maar ook collectieve waarden meewegen en in een journey terug wensen te zien. Hoe spoor je dit soort waarden op?

<!-- BLOK:ctaBlock heading="Klantperspectief" buttonLabel="Contact opnemen" buttonHref=/contact/ variant=default -->
### Klantperspectief
