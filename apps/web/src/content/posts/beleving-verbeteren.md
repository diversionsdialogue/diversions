---
title: "Patiëntbeleving verbeteren"
pubDate: 2021-12-19
description: "Als zorgorganisatie ben je, van diagnose tot behandeling en nazorg, onderdeel van het proces dat een patiënt doorloopt. In elk van deze fasen verschillen de behoeftes, emoties, verwachtingen en wensen van de patiënt. Het is de kunst hier als organisatie op de juiste manier op in te spelen."
author: "redactie"
image:
...
<!-- CONVERT-META
  oude_url: /beleving-verbeteren
  nieuwe_url: /blog/beleving-verbeteren
  sanity_type: post
  placeholder-afbeelding gebruikt (quality-fase: echte WP-afbeelding plaatsen)
  - 3 afbeelding(en) zonder alt -> quality-fase
-->
...
Bij Diversions zijn we ervan overtuigd dat je de patiëntbeleving kunt verbeteren door een unieke [patient journey](/patient-journey/) te maken.
...
<!-- IMG originele bron: https://www.diversions.nl/wp-content/uploads/2021/12/Icon_patient.png -- quality-fase: downloaden+optimaliseren -->
![](/src/images/assets/blog.jpeg)

#### Wat is een patient journey?

<!-- IMG originele bron: https://www.diversions.nl/wp-content/uploads/2021/12/Icon-mapping-1.png -- quality-fase: downloaden+optimaliseren -->
![](/src/images/assets/blog.jpeg)

#### Customer journey mapping

<!-- IMG originele bron: https://www.diversions.nl/wp-content/uploads/2021/12/Icon_aandacht.png -- quality-fase: downloaden+optimaliseren -->
![](/src/images/assets/blog.jpeg)
...
Een [patient journey](/patient-journey/) is een grafische weergave van het proces dat patiënten doorlopen binnen jouw organisatie. Als [onderzoeksbureau voor de zorg](/onderzoeksbureau-zorg/) kunnen we door middel van kwalitatief onderzoek, diepte-interviews en inzet van simulatie-patienten onderzoeken welke ervaringen patiënten doorlopen binnen deze tijdlijn en welke gevoelens zij daarbij hebben.
...
Elke zorgorganisatie is uniek. Samen met jou kijken we welke contactmomenten er tussen patiënt en organisatie binnen jouw organisatie bestaan. Deze contactmomenten [mappen](/patient-ervaring/) we op de tijdslijn. Ervaring leert dat verbeteren van patiëntbeleving het meest effectief is als je op deze voor de patiënt belangrijke momenten weet in te spelen.
