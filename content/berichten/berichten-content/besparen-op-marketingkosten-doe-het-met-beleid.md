---
titel: "Besparen op marketingkosten: doe het met beleid"
slug: "besparen-op-marketingkosten-doe-het-met-beleid"
oude_url: "https://www.diversions.nl/besparen-op-marketingkosten-doe-het-met-beleid/"
type: "post"
status: "publish"
concept: false
datum: "2020-09-21 20:29:56"
auteur: "redactie"
categorieen:
  - "optimalisatie"
tags: []
...
**Hoe kun je besparen op je marketingkosten? Het is een vraag die bij veel ondernemers speelt op dit moment. Door de onzekerheden rond Rusland-Oekraïne stijgen uitgaven in hoog tempo. Nu is het noodzakelijk om scherp te zijn op kosten. Maar dan wel op een manier die herstel van de crisis niet in de weg staat. Wij geven je handvatten om hiermee om te gaan.**

- [Marketing inrichten als een project](#project)
- [Breng kostensoorten in beeld](#kostensoorten)
- [Focus op de customer journey](#journey)
- [Automatiseer](#automatiseer)
- [Meten = weten](#meten)
...
[![scope-capaciteit-tijd](https://www.diversions.nl/wp-content/uploads/2020/12/Scope.png)](https://www.diversions.nl/wp-content/uploads/2020/12/Scope.png)
...
Het is belangrijk daar inzicht in te krijgen. Ik raad je aan dit op hoofdlijnen te doen. Je kunt natuurlijk kosten verdelen onder activiteiten als Advertenties, [SEO](https://www.diversions.nl/seo-marketing/), [SEA](https://www.diversions.nl/seo-marketing/organisch-en-betaald-zoekverkeer/), Social media etc. Maar dat impliceert al dat je deze verschillende kostensoorten allemaal nodig hebt. Dat is maar de vraag.
...
Het zetten van stap 1 en 2 zijn belangrijk, maar blijven algemeen. Nu komen we op het punt waar het meeste verlies en winst kan worden geboekt. We kijken naar marketingkosten in relatie tot de [customer journey](https://www.diversions.nl/customer-journey/).

Een journey kunnen we op hoofdlijnen en in detail in beeld brengen. We beperken ons nu tot de hoofdlijnen.

We richten ons hierbij op de standaard van [Google](https://marketingplatform.google.com/about/resources/analytics-customer-journey-feature-brief/):   
**See > Think > Do > Care**

![Customer journey - kosten besparen](https://www.diversions.nl/wp-content/uploads/2020/09/seethink.png)
...
De winnaars in online ([Amazon](https://www.amazon.nl/), Coolblue etc) steken al heel lang een relatief groot deel van hun budget in optimalisatie en personalisatie. Gebruik deze les juist in deze tijd.
...
Over de Breingeheimen valt veel te zeggen. Tijdens de corona-pandemie werden we verrast door de run op WC-papier, over de zeer persoonlijke kritiek op mensen als Ab Osterhaus of organisaties als het [RIVM](https://www.rivm.nl/). Veel kan verklaart worden als je weet hoe ons brein werkt. Je leest het in Breingeheimen.

[![Van overtuigingsprincipes naar breingeheimen](https://www.diversions.nl/wp-content/uploads/2019/11/breingeheimen-boek-1024x655.jpg)](https://www.diversions.nl/overtuigingsprincipes/)
...
![Marketing automation](https://www.diversions.nl/wp-content/uploads/2020/04/gebruiksvriendelijk-hubsot.jpg)
...
Het is één van de toepassingen van [marketing automation](https://www.diversions.nl/marketing-automation/). Een programma dat je eenmalig inricht, en dat vervolgens 24/7 inspeelt op de dan actuele informatiebehoefte van je bezoekers.
...
**Mijn persoonlijke ervaring**In 2008 was ik lid van het marketing MT in de zakelijke dienstverlening. Het leek een normaal jaar: we zaten vol ambities en ideeën. Tot na de val van de [Lehman Brothers](https://www.trouw.nl/nieuws/tien-jaar-na-de-val-van-lehman-brothers-zijn-er-nog-volop-risico-s~be552667/) alle plannen in de ijskast konden. We kregen een duidelijke opdracht: verlaag het marketingbudget per direct.
